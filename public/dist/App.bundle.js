...
function ajaxHeart(e) {
  ...
  _axios2.default //get the data
  .post(this.action) //this => will be the form tag
  .then(function (res) {
    var isHearted = _this.heart.classList.toggle("heart__button--hearted"); //this.heart will give the button
...
function typeAhead(search) {
  ...
  searchInput.on("keyup", function (e) {
    //40-down 38-up and 13-enter
    //if they are not pressing up,down or enter dont do anything
